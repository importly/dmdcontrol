...
# # from dmdcontrol.runtime.display_sequence import LutTimingMetadata, build_lut_entries
# # from . import display_sequence
...
#     def validate_timing(self, *, exposure_us: int) -> display_sequence.LutTimingMetadata:
...
#     count_slots_per_frame: int,
#     exposure_us: int,
#     count_blank_between_frames: bool = False,) -> display_sequence.LutTimingMetadata:
...
#         count_blank_between_frames=count_blank_between_frames,
#     )
#     _, _,  timing = display_sequence.build_lut_entries()
#     return timing

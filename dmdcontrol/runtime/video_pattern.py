...
# LutEntry = display_sequence.LutEntry
# LutTimingMetadata = display_sequence.LutTimingMetadata
...
#     entries, _, timing = display_sequence.build_lut_entries()
#     trigger_out_2_timing = display_sequence.compute_trigger_out_2_timing()

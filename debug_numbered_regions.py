...
def generate_crop_visualization(width, height, crop_x, crop_y, crop_w, crop_h):
    ...
    draw.rectangle([crop_x, crop_y, crop_x + crop_w, crop_y + crop_h], 
                   fill=(200, 200, 0), outline='red', width=5)
...
def save_numbered_diagnostics():
    ...
    img_full.save("diagnostic_numbered_full.png")
    print("    Saved: diagnostic_numbered_full.png")
    ...
    img_crop_viz.save("diagnostic_crop_visualization.png")
    print("    Saved: diagnostic_crop_visualization.png")
    ...
    img_cropped.save("diagnostic_numbered_crop.png")
    print("    Saved: diagnostic_numbered_crop.png")

...
echo "=== xinitrc_camera_sync_sweep: Configuring one spanning X screen ==="
sleep 1
...
echo "=== Launching dmdcontrol camera sync-sweep ==="
dmd_exec_python_module "$REPO_ROOT" dmdcontrol camera sync-sweep "$@"

...
./run_dmd_pair_capture.sh   --test a-kernel-b-static   --kernel-px 63   --kernel-exposure-us 6000   --dark-time-us 2000   --runtime-seconds 5   --polarity-mode ignore   --event-noise-filter none   --max-accumulation-triggers 512   --output-root runs/camera   -v
